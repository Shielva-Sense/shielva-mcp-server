...
def _build_security_fix_tool():
    ...
    try:
        ...
        if not s.mcp_vector_db_url:
            logger.warning(
                "security_fix_rag_disabled",
                reason="MCP_VECTOR_DB_URL not set in MCP .env",
            )
            return None
        ...
        from security_fix_tool.security_fix_tool import (
            SecurityFixTool,
            SecurityFixToolConfig,
        )
        ...
        logger.info(
            "SecurityFixTool loaded",
            provider=provider,
            table=s.security_fix_vector_table,
        )
        return tool
    except Exception as e:
            ...
            parameters=[
                {
                    ...
                    "type": "string",
                    "description": "Vulnerable code snippet or vulnerability description",
                    "required": True,
                },
                {
                    "name": "cve_id",
                ...
                },
                {
                    "name": "cwe_id",
                    "type": "string",
                    "description": "CWE class (e.g. CWE-89 for SQL injection)",
                    "required": False,
                },
                {
                    "name": "ecosystem",
                    "type": "string",
                    "description": "Package ecosystem: npm | PyPI | Go | Maven | RubyGems | NuGet",
                    "required": False,
                },
                {
                    "name": "package",
                ...
                },
                {
                    "name": "top_k",
                    "type": "integer",
                    "description": "Number of similar fixes to return (default: 5)",
                    "default": 5,
                    "required": False,
                },
            ],
